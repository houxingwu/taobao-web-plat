<template>
	<section>
		...
		<el-table :data="brands" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="productTypeId" label="商品类型" width="120" sortable>
			</el-table-column>
		...
		<el-col :span="24" class="toolbar">
			...
			<el-pagination layout="prev, pager, next" @current-change="handleCurrentChange" :page-size="pagaSiza" :total="total" style="float:right;">
			</el-pagination>
		</el-col>
